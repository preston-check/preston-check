...
The Preston-Check project is named in reference to the Bloxcross security incident of February 2026 that codified many of the attack patterns appearing in our check catalog. The full attack analysis is preserved in the project's whitepaper.
