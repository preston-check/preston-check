...
description: Detects violations of conservation invariants in financial calculations.
category: code-scan
severity: medium
languages: any
min_tier: free
...
frameworks: PCI-DSS:4.0:6.2.4, SOC2:TSC-2017:CC8.1, NIST-CSF:2.0:PR.DS-6
PRESTON_META
