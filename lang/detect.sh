...
load_language_profile() {
  ...
  case "$lang" in
    java)
      ...
      export BLACKLIST_PATTERN="blacklist\|blacklisted\|BLACK_LIST\|isBlacklisted"
      ...
      export PASSWORD_HASH_PATTERN="PBKDF2\|bcrypt\|scrypt\|argon2\|PasswordEncoder\|MessageDigest.*SHA"
      export JWT_VERIFY_PATTERN="verify.*jwt\|validateToken\|JWTVerifier\|parseClaimsJws\|Jwts.parser"
      ...
      export FOR_UPDATE_PATTERN="FOR UPDATE\|FOR NO KEY UPDATE\|advisory.*lock\|pg_advisory"
      export SECURE_RANDOM_PATTERN="SecureRandom\|crypto/rand"
      export HTTP_TIMEOUT_PATTERN="Timeout\|timeout\|ReadTimeout\|ConnectTimeout\|setConnectTimeout"
      ...
      export ROUNDING_MODE_PATTERN="RoundingMode\|HALF_UP\|HALF_EVEN\|CEILING\|FLOOR"
